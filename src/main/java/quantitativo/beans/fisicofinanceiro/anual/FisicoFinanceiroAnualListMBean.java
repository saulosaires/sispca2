...
public class FisicoFinanceiroAnualListMBean implements Serializable {
	...
	public FisicoFinanceiroAnualListMBean(AcaoService acaoService ,
		...
		atualizar = SessionUtils.containsKey("planejamentoQuantitativoFisicoFinanceiroAtualizar");
		relatorio = SessionUtils.containsKey("planejamentoQuantitativoFisicoFinanceiroRelatorio");
