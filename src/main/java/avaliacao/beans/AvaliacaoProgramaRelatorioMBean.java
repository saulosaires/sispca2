...
public class AvaliacaoProgramaRelatorioMBean extends AvaliacaoPrograma implements Serializable {
	...
	public static final String FAIL_REPORT = "Falha inesperada ao tentar Imprimir RelatÃ³rio";
	public static final String REPORT_EMPTY = "NÃ£o hÃ¡ dados para o programa Selecionado";
