...
@Named
@ViewScoped
public class RelatorioMetaFisicoFinanceiroMBean  extends RelatorioMBean {
	...
	@Inject
	public RelatorioMetaFisicoFinanceiroMBean(ExercicioService exercicioService,
	...
	public void gerarRelatorio() {
		...
		try {
			...
			List<FisicoFinanceiroMensalSiafem> listFisicoFinanceiro = fisicoFinanceiroMensalSiafemService.relatorioFinanceiroMetaFisico(unidadeGestora, unidadeOrcamentaria, acao, getExercicio());
			...
			if (comentario){
				report = FileUtil.getRealPath("/relatorios/financeiro/relatorio_metafisico_financeiro_com_observacao.jasper");
			}else {		
				report = FileUtil.getRealPath("/relatorios/financeiro/relatorio_metafisico_financeiro.jasper");
			}
